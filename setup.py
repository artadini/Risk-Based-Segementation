...
setup(name='groupc_dct_risk',
      version='0.2',  # Development release
      description='
Group Project - Risk Based Segmentation
This is document contains a description of the task and also a starter code. Implement your exercise by changing only this Jupyter Notebook and the class inside RiskDataFrame.py, deliver both files.
...
Your group is working in the retail risk modeling team and you are asked to build a class to perform risk-based segmentation and test it for car loans’ customers based on given historical data of customer behavior. The class must perform the segmentation from a risk management perspective',
      url='https://github.com/artadini/Risk-Based-Segementation',
      author='Group C',
      author_email='artadini@student.ie.edu',
      license='MIT',
          packages=['groupc_dct_risk'],
      zip_safe=False)